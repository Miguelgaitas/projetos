...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Out-2023 às 00:39
...
(10, 'ola', 'presiso de ajuda', '2023-10-23 09:06:03', 15);
...
(1, 'Arduino UNO Rev3', 'O Arduino Uno é uma placa eletrônica acessível, com ATmega328P, ideal para diversos projetos, suportada por uma comunidade robusta.', '24.00', 90, 'https://www.aquario.pt/pt/product/velleman-arduino-uno-rev3-arduino-uno-r3?gclid=Cj0KCQjw6cKiBhD5ARIsAKXUdybaDZYw0h6j2BcyESLE5E9W3Suoh0RrHJz2GWlWAAkjePCjIg7h3zIaAsurEALw_wcB'),
(2, 'OcioDual Kit 50 diodos LED 5 mm vermelho azul verde amarelo branco para robótica eletrónica', '\r\nO LED do Arduino emite luz com corrente elétrica, indicando estados em projetos eletrônicos controlados por programação em placas Arduino.', '100.00', 97, 'https://www.amazon.es/-/pt/dp/B077SDNZHT/ref=asc_df_B077SDNZHT/?tag=ptgogshpadde-21&linkCode=df0&hvadid=634424762838&hvpos=&hvnetw=g&hvrand=12330639144680755817&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=20871&hvtargid=pla-1178146536920&p');
...
(15, 'teste', 'teste@gmail.com', '202cb962ac59075b964b07152d234b70', 0, 'verificado');
