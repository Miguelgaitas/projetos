...
$sim = $_POST['simula'];
  ...
  if ($_FILES['imagem']['size'] > 0) {
    ...
    $sql = "UPDATE projetos_arduino SET nome='$nome', descricao='$descricao', imagem='$imagem', codigo='$codigo', simula='$sim' WHERE id=$projetoId";
  } else {
    // Atualiza os dados na tabela do banco de dados, sem modificar a imagem
    $sql = "UPDATE projetos_arduino SET nome='$nome', descricao='$descricao', codigo='$codigo', simula='$sim' WHERE id=$projetoId";
  }
