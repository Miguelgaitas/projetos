...
<div class="form-container">
      ...
      <form class="form" method="post" action="enviar_email.php">
        <div class="form-group">
          <label for="email"><h3>Email :</h3></label>
          <input  type="email" name="email" placeholder="Colocar o Email" style="font-size: 18px; font-weight: bold; color: #333;" required>
        </div>
      ...
      <p class="signup-link">
        Não tem uma conta?
        <a href="registro.php" class="signup-link link">Registo</a>
      </p>
    </div>
</body>
</html>
